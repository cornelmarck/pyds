...
def stage0_rule(m, stage=None):
    ...
    m.F_in_default[m.F_in] = {0:2.5, .2:0}
...
config_form = {
    'problem': {
        'stage rules': [stage0_rule, stage1_rule, stage2_rule],
        'model transformation': apply_collocation, #Post-construction model transformation
        'input map': {1: ['t_f', 'T'], 2: ['E1', 'E2', 'k1', 'k2']},
...
m = ThreeStageManager(config_form)
